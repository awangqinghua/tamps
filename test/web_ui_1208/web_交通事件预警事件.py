...
def click_test():
    ...
    time.sleep(2)
    ji_tong = wait.until(EC.element_to_be_clickable(
        (By.XPATH, '//*[@id="105$Menu"]/li[4]')
    ))
    ji_tong.click()
    yu_jin = wait.until(EC.element_to_be_clickable(
        (By.XPATH, '//*[@id="1035$Menu"]/li[1]/span[2]')
    ))
    yu_jin.click()
    browser.refresh()
    time.sleep(5)
    ...
    #     (By.XPATH, '//*[@class="ant-picker-datetime-panel"]//div[@class="ant-picker-header"]'
...
# 开始测试
    ...
    for i in texts:
        ...
        one_times = wait.until(EC.presence_of_element_located(
            (By.XPATH, '//*[@class="index_bigLayoutRow__1v09i"]'
                       '//*[@class="ant-space ant-space-horizontal ant-space-align-center"]/div[5]//span')
        )).text
        time.sleep(1)
        if int(one_times) != 0:
